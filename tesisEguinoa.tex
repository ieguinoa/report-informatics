...
% **********EN EL CAP.1 YA HICE UN RESUMEN DE LOS AVANCES QUE HUBO EN EL METODO EN SI, ES DECIR, LAS OPTIMIZACIONES QUE HAY BASADAS EN MODIFICAR EL ALGORITMO
...
%  **TAMBIEN DIJE QUE LO QUE VOY A HACER EN ESTE TRABAJO ES ADECUAR LAS IMPLEMENTACIONES ACTUALES PARA EXPLOTAR TODAS LAS CARACTERISTICAS DE LA GPU
% ******NO DIJE NADA SOBRE LA POSIBILIDAD DE USAR UNA TABLA PARA CALCULAR EL POTENCIAL******************
...
% PUEDO ARRANCAR DICIENDO QUE LA IMPLEMENTACION BASE SOBRE GPU ES CASI DIRECTA A PARTIR DE LAS ESPECIFICACIONES YA QUE EL ALGORITMO ES NATURALMENTE MUY PARALELO
%  ADEMAS, DE ESTA FORMA SE CONSIGUE UNA OPTIMIZACION MUY FACILMENTE
% EN ESTA IMPLEMENTACION DIRECTA (COMO EN EL CASO DE TODOS LOS ) EL CALCULO DEL POTENCIAL DE L-J SE HACE MEDIANTE THREADS QUE RESUELVEN EN BASE A LA ECUACION MOSTRADA EN EL CAP. 1
% ESTE PASO TIENE UN ORDEN DE N_2 Y POR LO TANTO SOBREPASA AMPLIAMENTE LAS CAPACIDADES DE COMPUTO DE CUALQUIER ARQUITECTURA GPU
...
% CIERRE DE INTRODUCCION: (YA ESTA BASTANTE BIEN ESCRITO)
% CIERRO DICIENDO QUE EN ESTE TRABAJO SE EVALUARAN DISTINTAS FORMAS DE IMPLEMENTAR ESTA MODIFICACION TENIENDO EN CUENTA LAS PROPIEDADES QUE OFRECE LA GPU ,
% QUE HAY QUE TENER EN CUENTA LA PROPAGACION DE ERRORES POR LA FORMA DEL ALGORITMO, ETC
% Y QUE LA MODIFICACION PUEDE SER APLICADA A CUALQUIER VERSION EXISTENTE Y DEBERIA AUMENTAR CONSIDERABLEMENTE LA PERFORMANCE
