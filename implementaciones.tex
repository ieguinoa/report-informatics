...
% Usando este esquema, con cualquier placa actual es posible lanzar en paralelo el calculo de ddtodas las distancias para sistemas de hasta Xxx partículas. 

Una vez que se conocen las distancias entre partículas, el siguiente paso consiste en calcular las fuerzas de interacción entre éstas.
...
Teniendo esto en cuenta, lo mas apropiado es utilizar una estructura en caché de 2 dimensiones.
...
% Teniendo en cuenta las consideraciones expresadas hasta ahora acerca de la implementación de una tabla en memoria de GPU, 
% las modificaciones para alojar en esta valores de la derivada son muy simples de implementar y, por lo tanto, no se darán más detalles de esta variante.
