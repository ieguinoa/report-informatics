...
Aún cuando el objetivo de este trabajo se centra en estudiar la eficienca de las implementaciones sobre GPU, la solución aqui planteada puede ser implementada en distintas arquitecturas.
