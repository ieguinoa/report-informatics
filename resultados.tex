...
Varios aspectos de los sistemas de prueba son relevantes para hacer una correcto análisis de los resultados. En el apéndice \ref{sistemas} se detalla la forma en que los sistemas de partículas fueron construidos y las propiedades de estos.
...
% \section{Performance}
\section{Evaluación de las implementaciones}
