...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\plotwidthsmaller]{img/cuda-gflops_ES.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\plotwidthverysmall]{img/fermi-sm.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\plotwidth]{img/fermi-gpu-block.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=250px]{img/cuda-memories_ES.pdf}
