...
% COMO OBJETIVO SECUNDARIO SE ESPERA OBTENER UN FRAMEWORK DE USO GENERAL PARA PROBAR DISTINTAS MODIFICACIONES SOBRE EL ALGORITMO DE DINAMICA MOLECULAR
...
La técnica de simulación de dinámica molecular se basa en resolver las ecuaciones de movimiento de Newton para cada átomo del sistema; así, en cada "paso" de la simulación se calcula la energía potencial entre las particulas y, de ésta, se derivan las fuerzas que actúan sobre cada átomo. 
...
% ACA PODRIA PONER QUE LOS QUIMICOS TIENEN MUCHOS PROBLEMAS PARA PROBAR LAS COSAS Y BLA BLA BLA YA QUE TIENEN ADAPTACIONES MUY PUNTUALES DEL SISTEMA QUE EJECUTAN(QUE CHAMUYO ACA?? ) 
...
% ******************************************
%    HASTA ACA ESTA BASTANTE COMPLETO 
% ******************************************
